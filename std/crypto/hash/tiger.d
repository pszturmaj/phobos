/**
Implementation of the Tiger and Tiger2 hash functions:

Standards: $(LINK2 http://www.cs.technion.ac.il/~biham/Reports/Tiger/, Tiger homepage)
...
///
class Tiger2 : TigerImpl!0x80
{
    version (unittest) static const string[] testVectors = [
        "", "4441be75f6018773c206c22745374b924aa8313fef919f41",
        "a", "67e6ae8e9e968999f70a23e72aeaa9251cbc7c78a7916636",
        "abc", "f68d7bc5af4b43a06e048d7829560d4a9415658bb0b1f3bf",
        "abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq",
...
class TigerImpl(ubyte pad) : MerkleDamgardImpl!(ulong, 3, 8, 8, 24)
{
    ...
    protected final override void transform() @safe nothrow
    {
        ...
        {
            void round(ref ulong a, ref ulong b, ref ulong c, size_t i) @trusted nothrow
            {
                c ^= w[i];
                auto cb = cast(ubyte*)&c;
                ...
                {
                    a -= t1[cb[7]] ^ t2[cb[5]] ^ t3[cb[3]] ^ t4[cb[1]];
                    b += t4[cb[6]] ^ t3[cb[4]] ^ t2[cb[2]] ^ t1[cb[0]];
                }
...
unittest
{
    testHashFunction!Tiger();
    testHashFunction!Tiger2();
}